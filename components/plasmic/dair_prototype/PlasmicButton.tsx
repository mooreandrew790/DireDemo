...
import sty from "./PlasmicButton.module.css"; // plasmic-import: zjt3HLSJYPM/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__msMgv)}
                role={"img"}
              />
            ),
      ...
      >
        {(hasVariant(variants, "color", "blue") ? true : true)
          ? p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__wddCf)}
                role={"img"}
              />
            ),
